...
const Home = () => {
  return (
    <div class="min-h-screen p-4 bg-slate-600 text-white flex flex-col gap-4 place-items-center justify-center">
      ...
      <div>
          <a href="/board" class="relative px-10 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
            ...
            <span class="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Game start</span>
          </a>
      </div>
    </div>
  )
